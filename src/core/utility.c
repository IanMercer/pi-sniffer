...
{
    add_key_value_double(builder, "phones", phones);
    add_key_value_double(builder, "watches", watches);
    add_key_value_double(builder, "wearables", wearables);
    add_key_value_double(builder, "computers", computers);
    add_key_value_double(builder, "tablets", tablets);
    add_key_value_double(builder, "beacons", beacons);
    add_key_value_double(builder, "covid", covid);
    add_key_value_double(builder, "other", other);
}